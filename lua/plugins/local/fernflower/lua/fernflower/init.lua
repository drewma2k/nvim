-- modified version of https://github.com/alienman5k/jdecomp.nvim
local M = {}
...
local function get_cmd (class_path, jar_path)
  ...
  elseif string.match(_config.decompiler, 'fernflower') then
	...
	if _config.provider.fernflower.bin ~= nil then
		table.insert(cmd, "fernflower")
	else
		table.insert(cmd, "java")
		table.insert(cmd, "-jar")
